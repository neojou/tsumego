...
`AlphaBetaSolver` answers 應手 / 反駁手。`searchPathCount` 是實際走完的條數，列表最多列 1000。開局白活點與蒙地卡羅不接入搜尋。不設時限（ADR-0019、0023）。最長抵抗先比黑能強迫的著手數，再黑最短勝枝的證明深度。反駁手優先做活點（兩眼第一手）；脫先則白直接下做活點。small_trick：黑 S19 應手 R19；黑 S19→R19→S15 反駁 T16；黑 S13 反駁 S19。
